...
//cart over
//connect to database (product  info)
...
<table width="780" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <td height="80" align="center" background="images/head.jpg" class="tdbline"></td>
  </tr>
  <tr>
        ...
        <tr valign="top">
          <td width="200" class="tdrline"><div class="boxtl"></div>
            ...
            <div class="categorybox">
              ...
              <p class="heading"><img src="images/16-star-orange.png" width="16" height="16" align="absmiddle"> 產品搜尋 <span class="smalltext">Search</span></p>
              ...
              <p class="heading"><img src="images/16-star-orange.png" width="16" height="16" align="absmiddle"> 價格區間 <span class="smalltext">Price</span></p>
            ...
            <div class="categorybox">
              ...
              <p class="heading"><img src="images/16-star-orange.png" width="16" height="16" align="absmiddle"> 產品目錄 <span class="smalltext">Category</span></p>
              <ul>
          ...
          <div class="subjectDiv"><span class="heading"><img src="images/16-star-green.png" width="16" height="16" align="absmiddle"></span> 購物結帳</div>
            <div class="normalDiv">
              <?php if($cart->itemcount > 0) {?>
              <!-- <p class="heading"><img src="images/16-cube-orange.png" width="16" height="16" align="absmiddle"> 購物內容</p> -->
              <p class="heading"><img src="images/16-star-orange.png" width="16" height="16" align="absmiddle"> 購物內容</p>
		  ...
		  ?>
              ...
              <p class="heading"><img src="images/16-star-orange.png" width="16" height="16" align="absmiddle"> 客戶資訊</p>
  ...
  <tr>
    <td height="30" align="center" background="images/album_r2_c1.jpg" class="trademark">Present by HanksCheng</td>
  </tr>
</table>
</body>
</html>
