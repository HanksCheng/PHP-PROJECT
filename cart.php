...
session_start();
$cart =& $_SESSION['cart']; //cart value to Session
  ...
  <tr>
    <td class="tdbline"><table width="100%" border="0" cellspacing="0" cellpadding="10">
      <tr valign="top">
        ...
        <td><div class="subjectDiv"> <span class="heading"><img src="images/16-star-green.png" width="16" height="16" align="absmiddle"></span> 購物車內容</div>
          <div class="normalDiv">
